...
function PdfCloudButtons({onStatus,onFile}) {
  ...
  return <div className="pdfCloudButtons">
    <button type="button" className="pdfCloudBtn" title="Select from Google Drive" aria-label="Select from Google Drive" onClick={drive}><span className="cloudCircle">▲</span><span>Select from Google Drive</span></button>
    <button type="button" className="pdfCloudBtn" title="Select from Dropbox" aria-label="Select from Dropbox" onClick={dropbox}><span className="cloudCircle">◇</span><span>Select from Dropbox</span></button>
  </div>;
}
